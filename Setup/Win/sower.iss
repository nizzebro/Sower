...
OutputDir=.
OutputBaseFilename=reaper_sower_full_install
...
[Files]
Source: "Full\reaper_sower32.dll"; DestDir: "{app}" ; Check: not IsWin64; Flags:ignoreversion
Source: "Full\reaper_sower64.dll"; DestDir: "{app}" ; Check: IsWin64; Flags:ignoreversion
